...
aov_file <- "ANOVA_trait_aov_tables_2023-04-26_10000perm.csv" # ANOVA results (trait levels)
pair_file <- "ANOVA_trait_pairwise_comps_2023-04-26_10000perm.csv" # ANOVA pairwise comparisons
stat_aov_file <- "ANOVA_trait_status_aov_tables_2023-04-26_10000perm.csv" # ANOVA on trait status (0 vs. 1)
